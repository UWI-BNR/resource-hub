# Hospital Cardiovascular Event Rate in Barbados
...
[Download Briefing](../../downloads/briefings/bnr-cvd-incidence-2023.pdf){ .md-button .btn-center target="_blank"}
...
## <span style="color:#A4161A;">Heart Attacks </span> Leave More Deaths Unseen than <span style="color:#8B6FB4;">Strokes</span>

![Figure 1](../../assets/images/bnrcvd-incidence-figure1.png){ align=left }

<div><span style="color:white;">spacer</span></div>

[:fontawesome-solid-file-excel:  Excel Download](../../downloads/data/bnrcvd-incidence-figure1.xlsx){ .md-button-data .btn-center target="_blank"}
[:fontawesome-solid-table:Stata Download](../../downloads/data/bnrcvd-incidence-figure1.dta){ .md-button-data .btn-center target="_blank"}
...
## Hospital Rates Show a Decade of Rising <span style="color:#8B6FB4;">Strokes</span> and Persistent Excess Among Men

![Figure 2](../../assets/images/bnrcvd-incidence-figure2.png){ align=left }

<div><span style="color:white;">spacer</span></div>

[:fontawesome-solid-file-excel:  Excel Download](../../downloads/data/bnrcvd-incidence-figure2.xlsx){ .md-button-data .btn-center target="_blank"}
[:fontawesome-solid-table:Stata Download](../../downloads/data/bnrcvd-incidence-figure2.dta){ .md-button-data .btn-center target="_blank"}
